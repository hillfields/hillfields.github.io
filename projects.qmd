...
-   **Modeling Japan's Activity Rates in the 21st Century** \| `r r_text()` \| [code](https://github.com/hillfields/PSTAT-174-Time-Series), [report](../files/modeling-activity-rates.pdf)
